...
export default function VideoPlayer() {
    ...
    useEffect(()=>{
       ...
       if(isPlaying){
         progressTime.current =  setInterval(oneProgress, 1000)
    ...
    useEffect(()=>{
      ...
      videoElement.addEventListener('seeked', oneProgress);
      setTime(0);
      pause();
      ...
      return() =>{
        ...
        videoElement.removeEventListener('seeked', oneProgress);
      }
    },[video])
    function play(){
    ...
    return (
        ...
        {video.url && (
            ...
            <div className="controls">
                <button onClick={isPlaying ? pause : play}> { isPlaying ? 'ii':'>'}</button>
